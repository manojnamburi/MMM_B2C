...
#var_control        = c('seasonality_gross_add_true','AR1', 'tp_price','competition','inflation','weather1','weather3') ##Minimum control
...
### Fit the MMM.
t0 <- Sys.time()
fit_PP_44_10_C19_xy995_beta_res_Appr3_45 = stan(file    = here::here("stanmodels", "stan_PP_44_10_C19_xy995_beta_res_Appr3_ub_hc.stan"),
...
save(fit_PP_44_10_C19_xy995_beta_res_Appr3_45, file = "RData/fit_PP_44_10_C19_xy995_beta_res_Appr3_45.RData")
