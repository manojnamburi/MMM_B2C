...
### Fit the MMM.
t0 <- Sys.time()
fit_PP_44_10_C19_xy995_beta_res = stan(file    = here::here("stanmodels", "stan_PP_44_10_C19_xy995_beta_res.stan"),
...
save(fit_PP_44_10_C19_xy995_beta_res, file = "RData/fit_PP_44_10_C19_xy995_beta_res.RData")
