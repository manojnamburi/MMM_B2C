...
##Change log:
1. Sai Tarun Yadalam: Changing the prior values of beta_media and gamma_media to negative half-normal to restrict gamma*Z_geo + sigma*beta to negative values
for applying upper bound for beta
*/
...
transformed data {
  //hard-coded UB
  matrix[num_geo, num_media] upper_bound =[[1,1,0.244,1,1,1,1,1,1,1],
[1,1,0.075,1,1,1,1,1,1,1],
[1,1,0.054,1,1,1,1,1,1,1],
[1,1,0.188,1,1,1,1,1,1,1],
[1,1,0.134,1,1,1,1,1,1,1],
[1,1,0.12,1,1,1,1,1,1,1],
[1,1,0.078,1,1,1,1,1,1,1],
[1,1,0.114,1,1,1,1,1,1,1],
[1,1,0.069,1,1,1,1,1,1,1],
[1,1,0.25,1,1,1,1,1,1,1],
[1,1,0.091,1,1,1,1,1,1,1],
[1,1,0.245,1,1,1,1,1,1,1],
[1,1,0.061,1,1,1,1,1,1,1],
[1,1,0.137,1,1,1,1,1,1,1],
[1,1,0.387,1,1,1,1,1,1,1],
[1,1,0.134,1,1,1,1,1,1,1],
[1,1,0.058,1,1,1,1,1,1,1],
[1,1,0.137,1,1,1,1,1,1,1],
[1,1,0.103,1,1,1,1,1,1,1],
[1,1,0.074,1,1,1,1,1,1,1],
[1,1,0.148,1,1,1,1,1,1,1],
[1,1,0.119,1,1,1,1,1,1,1],
[1,1,0.421,1,1,1,1,1,1,1],
[1,1,0.349,1,1,1,1,1,1,1],
[1,1,0.167,1,1,1,1,1,1,1],
[1,1,0.198,1,1,1,1,1,1,1],
[1,1,0.077,1,1,1,1,1,1,1],
[1,1,0.15,1,1,1,1,1,1,1],
[1,1,0.145,1,1,1,1,1,1,1],
[1,1,0.392,1,1,1,1,1,1,1]];
...
parameters {
  ...
  matrix<upper=0>[num_geo, num_media] beta_media_raw;       // the media parameters by geo-media
  matrix[num_geo, num_control] beta_control_raw;   // the control parameters by geo-control
 
 
  // Population-Level Parameters
  vector[num_grp_var] gamma_base; 
  matrix<upper=0>[num_grp_var, num_media] gamma_media; //exp(0.4) = 1.491825
...
transformed parameters {
  ...
  for (geo in 1:num_geo) { // How geo-level parameters be genearated.
    ...
    beta_media[geo, ]   = prior_location + (upper_bound[geo,] - prior_location).*exp(Z_geo[geo,]*gamma_media + sigma_media*beta_media_raw[geo, ]);
